...
function stageOne() {
  ...
  playerMessageEl.innerHTML =
    "Press the UP arrow to stop the slider in the BLUE bar";
  moveIntervalCaller = setInterval(
    moverUpDown,
    moverStartSpeed - moverIncrement * currentLevel
  );
...
function stageFour() {
  ...
  playerMessageEl.innerHTML =
    "QUICK! Press the DOWN arrow to lock out the weight!";
  moveIntervalCaller = setInterval(
    countDown,
...
function stageSix() {
  ...
  playerMessageEl.innerHTML =
    "Press the LEFT arrow to stop the slider inside the PURPLE bar";
  moveForward = false;
  moveIntervalCaller = setInterval(
    moverLeftRight,
    moverStartSpeed - moverIncrement * currentLevel
...
function stageSeven() {
  ...
  playerMessageEl.innerHTML =
    "Press the RIGHT arrow to stop the slider inside the PURPLE bar";
  moveForward = true;
  moveIntervalCaller = setInterval(
    moverLeftRight,
    moverStartSpeed - moverIncrement * currentLevel
